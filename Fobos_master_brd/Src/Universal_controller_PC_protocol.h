 ...
 * в т.ч. останавливать все движения если плата не примет никакого сообщения (любого) по Ethernet, посылать любую команду не реже чем 250 мс!
 ...
 * 						0 - состояние "датчик поворота рабочий нижний" Lateral view	(S3)
 *                      			1 - состояние "датчик поворота рабочий верхний"	AP view		(S4)
 *                  	    			2 - не исп.(по умолч. 0)
 *                  	    			3 - не исп.(по умолч. 0)
 *                  	    			4 - не исп.(по умолч. 0)
 *                  	    			5 - не исп.(по умолч. 0)
 ...
 *					0 - С-рама находится в неизвестном положении**НЕ ИСПОЛЬЗУЕТСЯ****
 *
