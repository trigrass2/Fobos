 ...
 * в т.ч. останавливать все движения если плата не примет никакого сообщения (любого) по Ethernet
 */
 ...
 *
 * 	Повернуть С-раму в начальное положение
 *	===TX
 *	CMD = 20	N = 0
 *	===RX
 ...
 *	===TX
 *	CMD = 21	N = 1	DATA0 = 1 - тип сканирования "фронтальное сканирование",
 *				DATA0 = 2 - тип сканирования "боковое сканирование",
 *				DATA0 = 3 - тип сканирования "фронтальное+боковое"
 *	===RX
