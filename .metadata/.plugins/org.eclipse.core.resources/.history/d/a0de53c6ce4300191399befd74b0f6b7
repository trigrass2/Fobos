 ...
 *						DATA3 - "боковая стойка" (	датчик установки стола в раб. положение ЛЕВЫЙ, 
 *													датчик препятствия (ИК-датчик),
 *													аварийный левый датчик С-рамы, 
 *													датчик установки стола в раб. положение ПРАВЫЙ	)
 *
 *	===TX (от ПК к контроллеру):
 *	CMD = 11	N = 0
 *	===RX (от контроллера к ПК)
